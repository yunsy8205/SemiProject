...
<!-- ------------------------------------------------------------------------------------------- -->
   ...
   <div class="container" >
   <div style="margin-left: 65%; margin-bottom: 3%;"><a href="../payment/bankadd?userNo=${member.userNo}" style="text-decoration: underline;">입금계좌 등록 ></a></div>
   ...
   <div class="row">
      ...
      <h1>구매내역</h1>
         ...
         <c:if test="${product.statusNo == 1}">
               ...
               <button class="btn btn-secondary ms-2"><a href="../product/reviewadd?proNo=${product.proNo}">후기!</a></button>
               </div>
