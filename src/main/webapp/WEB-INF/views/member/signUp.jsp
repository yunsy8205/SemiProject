...
<!-- 회원가입 폼 -->		
		<form class="align-center" action="./signUp" method="post" enctype="multipart/form-data" id="frm">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="id" name="userId" maxlength="20" placeholder="영문 대소문자와 숫자 4~8자리으로 id를 입력하세요">	
				<div class="checkResult" id="idResult"  style="display:none;">		
				</div>
				<button type="button" id="sameId" value="N">ID확인</button>
			</div>	
			<div class="form-group">
				<label for="userPw">비밀번호</label>		
				<input type="password" class="form-control" id="pw" name="userPw" maxlength="20" placeholder="패스워드를 입력하세요">
				<div class="checkResult" id="pwResult"></div>
			</div>	
			
			<div class="form-group">
				<label for="userPw2">비밀번호 확인</label>		
				<input type="password" class="form-control" id="pw2" maxlength="20" placeholder="패스워드를 한번 더 입력하세요">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="phone" name="phone" maxlength="13" placeholder="번호를 입력하세요">
